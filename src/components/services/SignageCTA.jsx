    ...
    return (
        <section ref={containerRef} className="pt-0 pb-0 bg-[var(--color-warm-gray)] relative overflow-hidden">
            ...
            >
                ...
                >
                    <h2 className="text-[var(--color-primary-red)] text-xs md:text-sm font-bold uppercase tracking-[0.4em] mb-4 md:mb-6">Visual Landmarks</h2>
                    ...
                    <p className="text-base md:text-2xl text-gray-400 font-light mb-8 md:mb-12 max-w-4xl mx-auto tracking-tight leading-relaxed">
                        Guide visitors with clear, professional signage and wayfinding systems. Share your signage requirements with our team for a consultation and tailored solutions designed for your space.
                    </p>
                    <Link
                        to="/contact"
