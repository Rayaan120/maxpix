    ...
    return (
        <section ref={containerRef} className="pt-0 pb-0 bg-[var(--color-warm-gray)] relative overflow-hidden">
            ...
            >
                ...
                >
                    <h2 className="text-[var(--color-primary-red)] text-xs md:text-sm font-bold uppercase tracking-[0.4em] mb-4 md:mb-6">Global Representation</h2>
                    <h3 className="text-2xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter leading-[0.9] mb-6 md:mb-10 drop-shadow-2xl uppercase">
                        Country Pavilion Exhibition Stand <br />
                        <span
...
export default CountryPavilionCTA;
