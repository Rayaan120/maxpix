    ...
    return (
        <section ref={containerRef} className="pt-0 pb-0 bg-[var(--color-warm-gray)] relative overflow-hidden">
            ...
            >
                ...
                >
                    <h2 className="text-[var(--color-primary-red)] text-xs md:text-sm font-bold uppercase tracking-[0.4em] mb-4 md:mb-6">Expertise & Innovation</h2>
