...
const KeyStats = () => {
    ...
    return (
        <section ref={containerRef} className="pt-4 pb-12 md:pt-6 md:pb-16 bg-[var(--color-warm-gray)] relative overflow-hidden flex flex-col items-center justify-center">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center mb-16">
                <motion.h2
                    ...
                    className="text-4xl md:text-5xl font-black text-[var(--color-charcoal)] mb-4 tracking-tight"
                >
                    Our Impact in Numbers
                </motion.h2>
                <div className="w-20 h-1.5 bg-[var(--color-primary-red)] mx-auto rounded-full"></div>
            </div>
