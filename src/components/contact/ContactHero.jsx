...
const ContactHero = () => {
    ...
    return (
        <section ref={containerRef} className="relative h-[80vh] flex items-center justify-center bg-[#0a0a0a] overflow-hidden rounded-b-[3rem] shadow-2xl z-20">
            ...
            <div className="absolute inset-x-0 bottom-0 h-[600px] bg-gradient-to-t from-[var(--color-primary-red)]/30 to-transparent blur-[100px]" />
            ...
            <motion.div style={{ y: y1, opacity, scale }} className="relative z-20 flex flex-col items-center justify-center text-center px-4 w-full pt-20">
                ...
                >
                    <p className="text-[var(--color-primary-red)] text-sm font-bold uppercase tracking-[0.2em] mb-6">Initiate Sequence</p>
                ...
                >
                    <p className="text-gray-400 text-lg md:text-xl font-light">
                        Don't settle for standard. Drop us a line below, share your CADs or creative brief, and our engineering team will calculate the feasibility, timeline, and impact of your next structural project.
                    </p>
                </motion.div>
            </motion.div>
